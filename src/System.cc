...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer,const string& strGTFile):mSensor(sensor), mpViewer(static_cast<Viewer*>(NULL)), mbReset(false),mbActivateLocalizationMode(false),
        mbDeactivateLocalizationMode(false),mbPause(false)
{
    ...
    if(!mbUseGT)
    {
        ...
        mpSMapper = new SemanticMapper(this,mpTracker,strSettingsFile);
...
cv::Mat System::TrackStereoSemantic(const cv::Mat &imLeft, const cv::Mat &imRight,const cv::Mat& imSeg, const double &timestamp)
{
